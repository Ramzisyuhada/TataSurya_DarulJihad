...
{
    private static GrabHandPoseR instance;
    public static GrabHandPoseR Instance {  get { return instance; } }

    public GameObject RightHandPhysic;
    ...
    public void SetupPose(BaseInteractionEventArgs args)
    {
        ...
        if (args.interactorObject is XRDirectInteractor rayInteractor)
        {
            ...
            if (handData != null)
            {
                ...
                RightHandPhysic.SetActive(false);
    ...
    public void UnsetPoses(BaseInteractionEventArgs args)
    {
        ...
        if (args.interactorObject is XRDirectInteractor rayInteractor)
        {
            ...
            if (handData != null)
            {
                ...
                RightHandPhysic.SetActive(true);
